...
ggplot(msi_alti, aes(x = Tumore, y = MSI, color = Tumore)) +
  ...
  labs(
    title = "Distribuzione MSI per tipo di tumore (MSI > 20) con significativitÃÂÃÂ ",
    x = "Tipo di tumore",
    y = "MSI"
  ) +
  theme_minimal() +
...
# ----------------------------
# 2. Dataset clinico pulito con MSI numerico e TEST DI FISHER: associazione MSI-H vs BRCA1/2
# ----------------------------
...
# ---------------------------
# 4. Rimozione varianti note giÃÂ  analizzate - Figura 22
# ---------------------------
...
>>>>>>> 88153c9fb5965697bb01122f05621a5d94f93cc2
